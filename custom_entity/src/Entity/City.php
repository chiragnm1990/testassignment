 ...
 *   You can see this in the entity.custom_entity_city.canonical
 *   route in the custom_entity_city.routing.yml file. The view can be
 ...
 *     "list_builder" = "Drupal\custom_entity\Entity\Controller\CityListBuilder",
 *     "form" = {
 *       "default" = "Drupal\custom_entity\Form\CityForm",
 *       "delete" = "Drupal\custom_entity\Form\CityDeleteForm",
 *     },
 *     "access" = "Drupal\custom_entity\CityAccessControlHandler",
 *   },
 ...
 *   },
 *   links = {
 *     "canonical" = "/custom_entity_city/{custom_entity_city}",
 *     "edit-form" = "/custom_entity_city/{custom_entity_city}/edit",
 *     "delete-form" = "/city/{custom_entity_city}/delete",
 *     "collection" = "/custom_entity_city/list"
 *   },
 *   field_ui_base_route = "custom_entity.city_settings",
 * )
 *
 ...
 *
 * Example: 'entity.custom_entity_city.canonical'.
 *
 * See the routing file at custom_entity.routing.yml for the
...
class City extends ContentEntityBase implements CityInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['city_name'] = BaseFieldDefinition::create('string')
      ...
      ->setDescription(t('The city name of the City entity.'))
      ->setSettings([
        'max_length' => 255,
        'text_processing' => 0,
      ])
