...
/**
 * Provides a list controller for custom_entity entity.
 *
...
//        '@adminlink' => $this->urlGenerator->generateFromRoute('custom_entity.city_settings'),
//      ]),
//    ];
  ...
  public function buildHeader() {
    $header['id'] = $this->t('Id');
    $header['city_name'] = $this->t('City Name');
  ...
  public function buildRow(EntityInterface $entity) {
    ...
    $row['id'] = $entity->id();
    $row['city_name'] = $entity->city_name->value;
